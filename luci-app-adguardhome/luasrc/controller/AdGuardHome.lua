...
function index()
local page = entry({"admin", "services", "AdGuardHome"},alias("admin", "services", "AdGuardHome", "base"),_(translate("AdGuard Home")))
page.order = 11
page.dependent = true
page.acl_depends = { "luci-app-adguardhome" }
    entry({"admin", "services", "AdGuardHome", "base"}, cbi("AdGuardHome/base"),  _(translate("Base Setting")), 1).leaf = true
    entry({"admin", "services", "AdGuardHome", "log"}, form("AdGuardHome/log"), _(translate("Log")), 2).leaf = true
    entry({"admin", "services", "AdGuardHome", "manual"}, cbi("AdGuardHome/manual"), _(translate("Manual Config")), 3).leaf = true
